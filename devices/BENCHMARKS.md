...
| ------------------------------------------------------------------------------------- | -------------- | ------- | --------------------------------- | ------------------------- | --------------- | --------------------- | ----------------- | ----------------------- |
| [Raspberry Pi Pico](https://www.raspberrypi.com/products/raspberry-pi-pico/) (RP2040) | Cortex-M0+     | 125 MHz | C, `-O3`                          | —                         | 2.25            | 44,523                | 0.081             | 1,234,004               |
| [Raspberry Pi Pico](https://www.raspberrypi.com/products/raspberry-pi-pico/) (RP2040) | Cortex-M0+     | 125 MHz | C, `-O3`                          | `TAMP_FAST_DECODE_LOOP=1` | 2.25            | 44,523                | 0.066             | 1,524,088               |
...
| ESP32                                                                                 | Xtensa LX6     | 160 MHz | ESP-IDF v6.0.2, `-O2`             | `TAMP_ESP32=1`            | 1.708           | 58,500                | 0.067             | 1,490,000               |
| ESP32-S3                                                                              | Xtensa LX7     | 160 MHz | ESP-IDF v6.0.2, `-O2`             | —                         | 1.487           | 67,200                | 0.051             | 1,977,000               |
| ESP32-S3                                                                              | Xtensa LX7     | 160 MHz | ESP-IDF v6.0.2, `-O2`             | `TAMP_ESP32=1` (PIE SIMD) | 0.255           | 392,600               | 0.048             | 2,066,000               |
| ESP32-C3                                                                              | RISC-V RV32IMC | 160 MHz | ESP-IDF v6.0.2, `-O2`             | —                         | 1.413           | 70,800                | 0.040             | 2,500,000               |
| ESP32-C3                                                                              | RISC-V RV32IMC | 160 MHz | ESP-IDF v6.0.2, `-O2`             | `TAMP_ESP32=1`            | 0.961           | 104,100               | 0.036             | 2,777,800               |
| STM32H7B0 [^sram]                                                                     | Cortex-M7      | 280 MHz | C, `-O3`, I+D cache               | —                         | 0.518           | 192,900               | 0.015             | 6,746,000               |
| STM32H7B0 [^sram]                                                                     | Cortex-M7      | 280 MHz | C, `-O3`, I+D cache               | `TAMP_ARMV7EM=1`          | 0.395           | 253,000               | 0.009             | 11,039,000              |
