...
| ------------------------------------------------------------------------------------- | -------------- | ------- | --------------------------------- | ------------------------- | --------------- | --------------------- | ----------------- | ----------------------- |
| [Raspberry Pi Pico](https://www.raspberrypi.com/products/raspberry-pi-pico/) (RP2040) | Cortex-M0+     | 125 MHz | C, `-O3`                          | —                         | 2.25            | 44,522                | 0.087             | 1,150,721               |
...
| ESP32-S3                                                                              | Xtensa LX7     | 160 MHz | ESP-IDF v6.0.2, `-O2`             | —                         | 1.487           | 67,200                | 0.052             | 1,912,000               |
| ESP32-S3                                                                              | Xtensa LX7     | 160 MHz | ESP-IDF v6.0.2, `-O2`             | `TAMP_ESP32=1` (PIE SIMD) | 0.255           | 392,600               | 0.050             | 1,987,000               |
...
| STM32H7B0 [^sram]                                                                     | Cortex-M7      | 280 MHz | C, `-O3`, I+D cache               | —                         | 0.518           | 192,900               | 0.015             | 6,574,000               |
| STM32H7B0 [^sram]                                                                     | Cortex-M7      | 280 MHz | C, `-O3`, I+D cache               | `TAMP_ARMV7EM=1`          | 0.395           | 253,000               | 0.015             | 6,732,000               |
