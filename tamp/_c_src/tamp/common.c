...
/* Cortex-M0/M0+: the fast-path variant below costs +150..250 bytes at -O3
 * (loop unrolling) and its speed is unvalidated on this core; keep the
 * original compact form until measured on hardware. */
