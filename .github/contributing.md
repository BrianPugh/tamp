...
1. We use [uv](https://docs.astral.sh/uv/getting-started/installation/) for
   managing virtual environments and dependencies. Once uv is installed, run
   `uv sync` in this repo to get started.
